...
# Suppose you have an environment variable called "MY_VARIABLE"
# You can access its value using the os.environ.get() function
...
class S3Client:
    ...
    def __init__(self):
        ...
        self._envs = {
            ...
            "region_name": os.environ.get("AWS_REGION", "us-west-1"),  # Using a default value if the variable is not defined
    ...
    def upload_file(self, data, s3_key):
        try:
            ...
            print("Credentials not found. Make sure to configure your AWS credentials correctly.")

    def download_file(self, s3_key):
        try:
            file = self.s3.get_object(Bucket=self._envs["s3_bucket"], Key=s3_key)
            print(f"Successful download for {s3_key}")
            return file
        except NoCredentialsError:
            print("Credentials not found. Make sure to configure your AWS credentials correctly.")
